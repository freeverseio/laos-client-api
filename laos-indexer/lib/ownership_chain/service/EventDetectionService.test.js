...
describe('EventDetectionService', () => {
    ...
    it('should detect new ERC721 universal contracts and transfers', () => {
        ...
        ctx = new Context_1.Context(mockdata_1.mockLogs);
        ...
        const service = new EventDetectionService_1.EventDetectionService(ctx, ownershipContractsToCheck);
        ...
        expect(detectedEvents.ownershipContracts[0]).toEqual({
