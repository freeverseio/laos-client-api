...
describe('IpfsService', () => {
    ...
    describe('ipfsUrlToHttpUrl', () => {
        it('should return empty string if url is falsy', () => {
            const service = new IpfsService_1.IpfsService();
    ...
    describe('getDataFromIpfs', () => {
        it('should fetch data from IPFS URL', async () => {
            const service = new IpfsService_1.IpfsService();
            const fetchDataSpy = jest.spyOn(service, 'fetchData').mockResolvedValue({ data: 'test' });
    ...
    describe('getTokenURIData', () => {
        ...
        xit('should fetch and map token URI data correctly', async () => {
            ...
            jest.spyOn(service, 'getDataFromIpfs').mockResolvedValue(mockData);
        ...
        it('should throw an error if data is null', async () => {
            const service = new IpfsService_1.IpfsService();
            jest.spyOn(service, 'getDataFromIpfs').mockResolvedValue(null);
...
//# sourceMappingURL=IpfsService.test.js.map